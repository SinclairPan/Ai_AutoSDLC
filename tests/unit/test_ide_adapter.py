...
class TestApplyAdapter:
    ...
    def test_migrates_alternate_vscode_adapter(self, tmp_path: Path) -> None:
        ...
        alternate.write_text("alternate content", encoding="utf-8")
