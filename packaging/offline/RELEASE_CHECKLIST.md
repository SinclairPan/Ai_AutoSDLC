# AI-SDLC 3.0.1 离线发布检查清单

当前源码与公开稳定版本均为 `3.0.1` / `v3.0.1`。以下条目用于候选构建、Draft Release 复验和发布后验证。

## 版本与源码

- [ ] `pyproject.toml` 为 `3.0.1`；
- [ ] 两个 `ai_sdlc/__init__.py` 回退版本均为 `3.0.1`；
- [ ] `uv.lock` 中本项目版本为 `3.0.1`；
...
- [ ] 精确 main SHA 上存在 annotated tag `v3.0.1` 和全新的空 Draft Release；
