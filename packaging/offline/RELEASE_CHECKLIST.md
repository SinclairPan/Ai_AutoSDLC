# AI-SDLC 1.0.1 离线发布检查清单

## 版本与源码

- [ ] `pyproject.toml` 为 `1.0.1`；
- [ ] 两个 `ai_sdlc/__init__.py` 回退版本均为 `1.0.1`；
- [ ] `uv.lock` 中本项目版本为 `1.0.1`；
