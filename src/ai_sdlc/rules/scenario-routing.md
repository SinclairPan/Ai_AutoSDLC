...
3. 切回设计层：
   a. 若当前 docs 分支仍存在：checkout `feature/<WI>-docs`（也支持 `design/<WI>-docs`），更新 spec.md / plan.md / tasks.md（或增量文件）
   b. 若 docs 分支已合并：从 `main` 新建新的 docs 分支，命名遵循 `git-branch.md`（首选 `feature/<WI>-docs`，也支持 `design/<WI>-docs`）
