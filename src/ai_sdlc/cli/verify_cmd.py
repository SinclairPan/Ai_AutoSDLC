...
@verify_app.command(
    ...
    help=(
        ...
        "for the framework-owned 003-cross-cutting authoring work item, the draft "
        "PRD, reviewer decision, backend delegation/fallback, and release-gate "
        "evidence surfaces must be present; "
