...
$DownloadRoot = Join-Path $env:TEMP "ai-sdlc-v1.0.3-download"
$BundleName = "ai-sdlc-offline-1.0.3-windows-amd64"
$PackageName = "$BundleName.zip"
$PackageUrl = "https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/ai-sdlc-offline-1.0.3-windows-amd64.zip"
$ChecksumUrl = "https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/ai-sdlc-offline-1.0.3-windows-amd64.zip.sha256"
...
```text
SHA256 verified: ai-sdlc-offline-1.0.3-windows-amd64.zip
Result
...
```powershell
$ProjectRoot = Join-Path $HOME "projects\my-new-project"
$DirectCli = Join-Path $HOME "AI-SDLC\ai-sdlc-offline-1.0.3-windows-amd64\.venv\Scripts\ai-sdlc.exe"
Set-Location $ProjectRoot
& $DirectCli init .
```
...
以下命令在 Terminal 的 zsh 或 bash 中执行。v1.0.3 的正式 macOS 离线包适用于 Apple Silicon。
...
BUNDLE_NAME="ai-sdlc-offline-1.0.3-macos-arm64"
PACKAGE_NAME="$BUNDLE_NAME.tar.gz"
PACKAGE_URL="https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/ai-sdlc-offline-1.0.3-macos-arm64.tar.gz"
CHECKSUM_URL="https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/ai-sdlc-offline-1.0.3-macos-arm64.tar.gz.sha256"
...
```text
ai-sdlc-offline-1.0.3-macos-arm64.tar.gz: OK
当前结果 / Result
...
```bash
PROJECT_ROOT="$HOME/projects/my-new-project"
DIRECT_CLI="$HOME/Applications/AI-SDLC/ai-sdlc-offline-1.0.3-macos-arm64/.venv/bin/ai-sdlc"
cd "$PROJECT_ROOT"
"$DIRECT_CLI" init .
```
...
DOWNLOAD_ROOT="$(mktemp -d)"
BUNDLE_NAME="ai-sdlc-offline-1.0.3-linux-amd64"
PACKAGE_NAME="$BUNDLE_NAME.tar.gz"
PACKAGE_URL="https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/ai-sdlc-offline-1.0.3-linux-amd64.tar.gz"
CHECKSUM_URL="https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/ai-sdlc-offline-1.0.3-linux-amd64.tar.gz.sha256"
...
```text
ai-sdlc-offline-1.0.3-linux-amd64.tar.gz: OK
当前结果 / Result
  离线安装完成。安装脚本已创建运行环境并安装 AI-SDLC。
  Offline installation completed. The installer created the runtime and installed AI-SDLC.
下一步 / Next
...
```bash
PROJECT_ROOT="$HOME/projects/my-new-project"
DIRECT_CLI="$HOME/.local/share/AI-SDLC/ai-sdlc-offline-1.0.3-linux-amd64/.venv/bin/ai-sdlc"
cd "$PROJECT_ROOT"
"$DIRECT_CLI" init .
```
...
```text
https://github.com/SinclairPan/Ai_AutoSDLC/releases/download/v1.0.3/
```
