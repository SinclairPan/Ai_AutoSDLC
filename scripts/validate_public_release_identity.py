...
REQUIRED_SURFACES: dict[str, tuple[str, ...]] = {
    ...
    "USER_GUIDE.zh-CN.md": (
        ...
        "## 第一章：全新用户 + 全新空项目",
        "## 第二章：全新用户 + 已有项目",
        "releases/download/v1.0.1/ai-sdlc-offline-1.0.1-windows-amd64.zip",
        "releases/download/v1.0.1/ai-sdlc-offline-1.0.1-macos-arm64.tar.gz",
        "releases/download/v1.0.1/ai-sdlc-offline-1.0.1-linux-amd64.tar.gz",
